...
def originHandle():
    with open('./renmin.txt', 'r', encoding='utf8') as inp, open('./renmin2.txt', 'w') as outp:
        for line in inp.readlines():
            ...
            outp.write('\n')
def originHandle2():
    with codecs.open('./renmin2.txt', 'r') as inp, codecs.open('./renmin3.txt', 'w') as outp:
        for line in inp.readlines():
            line = line.split(' ')
            i = 0
            while i < len(line)-1:
...
def sentence2split():
    with open('./renmin3.txt') as inp, codecs.open('./renmin4.txt', 'w') as outp:
...
def data2pkl():
    ...
    tags = set()
    tags.add('')
    input_data = codecs.open('renmin4.txt', 'r')
